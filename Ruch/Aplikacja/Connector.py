...
class Connector:
    ...
    def get_header_sql_type(self):
        ...
        typy = {"@": "Varchar(60)", "0": "Integer", "0.00": "Integer", "General": "Varchar(60)", "mm-dd-yy": "date"}
        typsy = []
        for x in header:
    ...
    def get_row(self, row_number):
        ...
        for column in range(1, self.get_max_x() + 1):
            if self.get_header_type()[column - 1] in ["@", "General"]:
    ...
    def insert_selected_excel_sheet_data_into_sql(self, sheetlist):
